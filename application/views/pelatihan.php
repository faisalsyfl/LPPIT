                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6" style="margin-bottom: 20px;">
                        <div class="text-center">
                            <a href="<?php echo base_url(); ?>uploads/galeri/<?php echo $row['filename']; ?>" class="zoom"><img src="<?php echo base_url(); ?>uploads/galeri/<?php echo $row['filename']; ?>" class="img-responsive rounded" alt="..."></a>
                        </div>
                    </div>
                    <?php } ?>
                </div>
